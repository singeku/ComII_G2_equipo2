...
class punto_7_practica_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "punto_7_practica_4")
...
def main(top_block_cls=punto_7_practica_4, options=None):
