...
\begin{figure}[H]
    \centering
    \subfloat[Cruce por cero en el extremo negativo.]{\includegraphics[width=0.6\linewidth]{imagenes/ancho_de_banda_extremo_negativo.png}\label{fig:psd_neg}}
    \hfill
    \subfloat[Cruce por cero en el extremo positivo.]{\includegraphics[width=0.6\linewidth]{imagenes/ancho_de_banda_extremo_positivo.png}\label{fig:psd_pos}}
...
\begin{figure}[H]
    \centering
    \subfloat[Configuración del vector en GNU Radio.]{\includegraphics[width=0.55\linewidth]{imagenes/tabla_de_verdad.png}\label{fig:vector_config}}
    \hfill
    \subfloat[Constelación Q-PSK bajo efecto del canal AWGN.]{\includegraphics[width=0.6\linewidth]{imagenes/constelaciones.png}\label{fig:const_grafica}}
