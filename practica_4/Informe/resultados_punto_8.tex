...
\begin{table}[H]
    ...
    \begin{tabular}{l l l}
        ...
        Jordy & (Estrella) & $[0.5+0j, 0.707+0.707j, 0+0.5j, -0.707+0.707j, -0.5+0j, -0.707-0.707j, 0-0.5j, 0.707-0.707]$ \\
        Valentina & (Ovalo alargado) & $[0.5+0.5j, -0.5+0.5j, -0.5-0.5j, 0.5-0.5j, 1.2+0j, 0+1.2j, -1.2+0j, 0-1.2j]$ \\
        \bottomrule
    \end{tabular}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[Diseño Juan D.]{\includegraphics[width=0.32\linewidth]{imagenes/constelacion_creada.png}\label{fig:cj}}
    %\hfill
    % [NOTA: Jordy y Valentina deben cambiar "imagen_vacia.png" por los nombres de sus capturas]
    \subfloat[Diseño Jordy]{\includegraphics[width=0.32\linewidth]{/home/valentina/ComII_G2_equipo2/practica_4/Informe/imagenes/y.jpeg}\label{fig:cjo}}
    %\hfill
    \subfloat[Diseño Valentina]{\includegraphics[width=0.32\linewidth]{/home/valentina/ComII_G2_equipo2/practica_4/Informe/imagenes/8.jpeg}\label{fig:cva}}
...
Al observar los resultados en el Constellation Sink, se concluye que las constelaciones no tienen que ser necesariamente circulares (PSK). Sin embargo, al usar amplitudes menores para ciertos símbolos, estos se vuelven más vulnerables al ruido de canal (AWGN) como se observa en el resultado de valentina, lo que aumenta la probabilidad de error en comparación con una 8-PSK convencional de potencia constante y este factor aumenta aun mas en el resultado dado por yordi.