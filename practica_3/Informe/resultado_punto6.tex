\section{Análisis del modulador OOK en RF y Envolvente Compleja}

Como punto de partida, se presenta un conjunto inicial de gráficas que permiten visualizar el comportamiento general del sistema. Estas incluyen la señal binaria bipolar, la señal modulante, la señal modulada en RF y su representación en envolvente compleja (EC). Este conjunto sirve como referencia base para comprender la relación entre las distintas etapas del proceso de modulación.

\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{imagenes/6.1.jpeg}
\caption{Visualización general del sistema: señal bipolar, modulante, RF y envolvente compleja.}
\label{fig:collage_inicial}
\end{figure}
