...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.blk(fc=100000, samp_rate=samp_rate)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff((2*math.pi/samp_rate))
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, 25000, 0, 0)
        ...
        self.connect((self.epy_block_0_1, 0), (self.epy_block_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_multiply_const_vxx_0.set_k((2*math.pi/self.samp_rate))
