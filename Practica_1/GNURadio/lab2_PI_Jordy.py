...
import lab2_PI_Jordy_epy_block_0 as epy_block_0  # embedded python block
import sip



class lab2_PI_Jordy(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_PI_Jordy")
...
def main(top_block_cls=lab2_PI_Jordy, options=None):
