...
import numpy as np
import punto_3_epy_block_0 as epy_block_0  # embedded python block
import sip
...
class punto_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.h = h = firdes.root_raised_cosine(1, Sps, 1, 0.35, 11*Sps)
        self.N = N = 1024
        ...
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 0.2, 76)
    ...
    def set_Sps(self, Sps):
        self.Sps = Sps
        self.set_h(firdes.root_raised_cosine(1, self.Sps, 1, 0.35, 11*self.Sps))
